                ...
                <div class="sm:grid sm:grid-cols-4 m-4">  
                    ...
                    <div class="m-2">
                        ...
                        <ul class="flex text-gray-600 text-sm mt-2">
                            <li class="pr-2  cursor-pointer">
                                <a href="https://instagram.com/skin911.official?utm_medium=copy_link">
                                    <svg class="fill-current hover:text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 30 30">
                    ...
                    <div class="m-2">
                        ...
                        <ul style="font-family: 'futura-pt', arial, sans-serif;" class="text-gray-600 text-sm tracking-wide">
                            ...
                            <li class="hover:text-blue-500 cursor-pointer">
                                <div class="flex">
                                    <a href="tel:7085203615" class="pr-2">Customer Care: + 7085203615</a>
                            ...
                            <li class="hover:text-blue-500 cursor-pointer">
                                <div class="flex">
                                    <span class="pr-2">Business hours: 10:00 AM - 11:00 PM</span>
                                    <!-- <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 32">
