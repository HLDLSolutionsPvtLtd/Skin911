                   ...
                   <div v-show="newbrand" class="absolute bg-white w-full p-4 border shadow-lg">
                       ...
                       <div class="flex mt-4 flex-col">
                           ...
                           <div class="flex mt-2 gap-2">
                               <div class="">
                                    <jet-label class="text-sm tracking-wider" for="size" value="Applicable For"/>
                                    <div class="mt-2">
                                        <select name="" class="border-gray-300 text-sm rounded-md" v-model="form.for" id="">
                                ...
                                <div class="" v-show="form.for">
                                    <jet-label class="text-sm tracking-wider" for="size" :value="'Select '+ form.for"/>
                                    <div class="mt-2">
                                        <select name="" class="border-gray-300 text-sm rounded-md" id="">
                                            <!-- <template v-for="">
                                                <option value=""></option>
                                            </template> -->
                                        </select>
