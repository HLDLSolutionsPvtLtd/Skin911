                ...
                <div class="m-2">
                    ...
                    <div style="height:calc(100vh - 180px);scrollbar-width:thin" class="overflow-y-scroll">
                        <table class="w-full text-ct">
                            ...
                            <tr v-for="(banner, index) in banners.data" :key="banner.id" class="border-b-2 text-sm font-semibold text-gray-500 tracking-wider border-gray-200">   
                        ...
                        <div class="w-full mt-8">
                            <div class="w-full flex justify-center items-center">
                                <div class="flex gap-2 border justify-center items-center text-blue-500" v-for="(link, index) in banners.links">
                                    ...
                                    <button @click="fetchData(link.url)" :disbled="link.active" :class="{'bg-gray-200': !link.active}" v-else-if="index == banners.links.length - 1" class="border border-blue-400 cursor-pointer">
